                ...
                <div class="table-responsive">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="student" id="" class="form-control select2" required>
                                <option value="" disabled selected>Select</option>
                                @foreach(\App\User::orderBy('matric_number')->where('role_id',1)->get() as $value)
                                    <option value="{{$value->id}}"> {{ strtoupper($value->matric_number) }} ( {{ucwords($value->full_name)}} )</option>
                                @endforeach
                            </select>
                        </div>
