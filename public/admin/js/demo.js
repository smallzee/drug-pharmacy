...
//    }
 ...
 var $skinsList = $('<ul />', { 'class': 'list-inline clearfix theme-switch' })
  ...
  $demoSettings.append(
    ...
    ../http/theme skin toggle	  	+_358236530.html '<div class="flexbox mb-10 pb-10 bb-1 light-on-off">'
  ...
  $demoSettings.append(
    ...
    ../http/rtl layout	+_1327260011.html '<div class="flexbox mb-10 pb-10 bb-1">'
  ...
  $demoSettings.append(
    '<h4 class="control-sidebar-heading p-0">'
    + '</h4>' 	
    ../http/sidebar toggle	+_578290185.html '<div class="flexbox mb-10">'
	...
	+ '</label>'
	+ '</div>'  
    ../http/control sidebar toggle	+_1987707416.html '<div class="flexbox mb-10">'
